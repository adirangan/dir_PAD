...
[Z2_base_0,l2_stretch_0] = SDE3d_missing_2d_integral_helper_0(0,C_omega_,C_l0,C_l1,C_l2); %<-- ignore XY_(1+0) ;
[Z2_base_1,l2_stretch_1] = SDE3d_missing_2d_integral_helper_0(1,C_omega_,C_l0,C_l1,C_l2); %<-- ignore XY_(1+1) ;
[Z2_base_2,l2_stretch_2] = SDE3d_missing_2d_integral_helper_0(2,C_omega_,C_l0,C_l1,C_l2); %<-- ignore XY_(1+2) ;
