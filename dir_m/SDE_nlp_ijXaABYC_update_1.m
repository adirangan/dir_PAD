...
str_thisfunction = 'SDE_nlp_ijXaABYC_update_1';
...
nlp_ijXYC_pre = f_nlp([C_omega,C_l0,C_l1]);
...
nlp_ijXYC_pos = f_nlp([C_omega,C_l0,C_l1]);
if (flag_verbose>0);
disp(sprintf(' %% C_omega %+0.2f C_l0 %+0.2f C_l1 %+0.2f: nlp_ijXYC %0.6f --> %0.6f',C_omega,C_l0,C_l1,nlp_ijXYC_pre,nlp_ijXYC_pos));
...
nlp_idtZPB_pre = f_nlp([B_omega,B_l0,B_l1]);
...
nlp_idtZPB_pos = f_nlp([B_omega,B_l0,B_l1]);
%%%%%%%%%%%%%%%%;
if (flag_verbose>0);
disp(sprintf(' %% B_omega %+0.2f B_l0 %+0.2f B_l1 %+0.2f: nlp_idtZPB %0.6f --> %0.6f',B_omega,B_l0,B_l1,nlp_idtZPB_pre,nlp_idtZPB_pos));
end;%if (flag_verbose>0);
