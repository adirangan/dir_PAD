...
tmp_dir = sprintf('%s/dir_test_dolphin_%s',dir_dolphin_mat,dir_infix);
if ~exist(tmp_dir,'dir') disp(sprintf(' %% mkdir %s',tmp_dir)); mkdir(tmp_dir); end;
tmp_fname_mat_ini = sprintf('%s/test_dolphin_%s.mat',dir_dolphin_mat,str_infix);
tmp_fname_mat_fin = sprintf('%s/dir_test_dolphin_%s/test_dolphin_%s.mat',dir_dolphin_mat,dir_infix,str_infix);
...
fname_pre = sprintf('%s/dir_test_dolphin_%s/test_dolphin_%s',dir_dolphin_mat,dir_infix,str_infix);
