...
str_thisfunction = 'SDE3d_generate_data_3_wrap_0';
...
if (nargin<1+na); B_tru_omega_=[]; end; na=na+1;
if (nargin<1+na); B_tru_l0=[]; end; na=na+1;
if (nargin<1+na); B_tru_l1=[]; end; na=na+1;
if (nargin<1+na); B_tru_l2=[]; end; na=na+1;
if (nargin<1+na); C_tru_omega_=[]; end; na=na+1;
if (nargin<1+na); C_tru_l0=[]; end; na=na+1;
if (nargin<1+na); C_tru_l1=[]; end; na=na+1;
if (nargin<1+na); C_tru_l2=[]; end; na=na+1;
...
%%%%;
if isempty(B_tru_omega_); B_tru_omega_ = zeros(n_x,1); end;
if isempty(B_tru_l0); B_tru_l0 = 0; end;
if isempty(B_tru_l1); B_tru_l1 = 0; end;
if isempty(B_tru_l2); B_tru_l2 = 0; end;
[ ...
 ~ ...
,BtBn_tru_xx__ ...
] = ...
...
%%%%;
if isempty(C_tru_omega_); C_tru_omega_ = zeros(n_x,1); end;
if isempty(C_tru_l0); C_tru_l0 = 0; end;
if isempty(C_tru_l1); C_tru_l1 = 0; end;
if isempty(C_tru_l2); C_tru_l2 = 0; end;
[ ...
 ~ ...
,CtCn_tru_xx__ ...
] = ...
