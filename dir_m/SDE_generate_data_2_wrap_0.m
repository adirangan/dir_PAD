...
if (nargin<1+na); log_amplitude=[]; end; na=na+1;
...
if (~isfield(parameter,'relative_variation')); parameter.relative_variation = 1.0; end;
...
relative_variation = parameter.relative_variation;
...
PAD_BtBn_0( ...
 [] ...
,B_tru_omega ...
,B_tru_l0 + log_amplitude ...
,B_tru_l1 + log_amplitude ...
);
...
PAD_BtBn_0( ...
 [] ...
,C_tru_omega ...
,C_tru_l0 + log_amplitude ...
,C_tru_l1 + log_amplitude ...
);
...
RY_l2 = abs(RY_avg - relative_variation).^2;
